...
#Name of user: 
#Date: 10/23/2023
#Explanation: This script is a straightforward approach to run a few cells and generate a quick statement with forecast estimates.
#To get started click the 'run-cell' button below and execute each of the following steps to complete the script.
